...
LastEditTime: 2022-03-22 17:26:24
...
# d2l.plt.show()  # 显示散点图
viz = visdom.Visdom(env='linreg')
win = viz.scatter(X=torch.cat((X_features[:, 1].reshape(len(y_labels), 1), y_labels.reshape(len(y_labels), 1)), 0))
