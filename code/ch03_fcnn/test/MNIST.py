...
train_dataset = datasets.MNIST(root='../../ch00_dataset', train=True, transform=data_tf, download=False)
test_dataset = datasets.MNIST(root='../../ch00_dataset', train=False, transform=data_tf)
